...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#030712] relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-4 bg-white/[0.02] border border-white/5 backdrop-blur-sm p-8 rounded-2xl z-10 relative">
        ...
        {step === 1 ? (
          <form onSubmit={handleCredentialsSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-[#4F46E5] text-white py-3 rounded-lg font-bold text-xs uppercase hover:translate-y-[-2px] transition-all duration-200 shadow-lg shadow-[#4F46E5]/20 flex items-center justify-center gap-2"
            >
          ...
          <form onSubmit={handleMfaSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full bg-[#10B981] text-white py-3 rounded-lg font-bold text-xs uppercase hover:translate-y-[-2px] transition-all duration-200 shadow-lg shadow-[#10B981]/20 flex items-center justify-center gap-2"
            >
